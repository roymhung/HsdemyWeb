        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Update Chapter</h1>
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item"><a href="/admin">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="/admin/course">Course</a></li>
                        <li class="breadcrumb-item"><a href="/admin/course/${course.id}">Detail</a></li>
                        <li class="breadcrumb-item active">Update Chapter</li>
                    </ol>

                    <div class="card">
                        <div class="card-header fw-semibold">Edit Chapter #${newChapter.id}</div>
                        <div class="card-body">
                            <form:form method="POST" action="/admin/course/${course.id}/chapter/update" modelAttribute="newChapter"
                                class="row g-3">
                                <form:hidden path="id" />
                                <div class="col-md-2">
                                ...
                                <div class="col-12 d-flex gap-2">
                                    ...
                                    <a href="/admin/course/${course.id}" class="btn btn-outline-secondary">Cancel</a>
                                </div>
                            </form:form>
                        </div>
                    </div>
