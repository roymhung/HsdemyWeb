                    ...
                    <main>
                        <div class="container-fluid px-4">
                            <div class="admin-page-heading">
                                <h1 class="mt-4 mb-1">Quản lý người dùng</h1>
                                <p class="text-muted mb-4">Quản lý tài khoản người dùng, phân quyền và thông tin hồ sơ
                                    tập trung.</p>
                            </div>
                                ...
                                <div class="col-xl-3 col-md-6">
                                    <div class="admin-stat-card">
                                        <div class="admin-stat-icon bg-success-subtle text-success"><i
                                                class="fas fa-filter-circle-dollar"></i></div>
                                        <div>
                            ...
                            <div class="card admin-card mb-4">
                                <div class="card-header bg-white d-flex justify-content-between align-items-center">
                                    <h5 class="fw-semibold mb-0"><i class="fas fa-filter me-2 text-primary"></i>Tìm kiếm
                                        & bộ lọc</h5>
                                    ...
                                    <form method="get" action="/admin/user" class="row g-3">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <select class="form-select" name="role">
                                                <option value="ALL" ${selectedRole=='ALL' ? 'selected' : '' }>Tất cả
                                                </option>
                            ...
                            <div class="card admin-card mb-4">
                                <div class="card-header bg-white">
                                    <h5 class="fw-semibold mb-0"><i class="fas fa-table me-2 text-primary"></i>Danh sách
                                        người dùng</h5>
                                </div>
                                    ...
                                    <table class="table table-hover align-middle admin-table mb-0">
                                        ...
                                        <tbody>
                                            <c:forEach var="user" items="${users1}">
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="small text-muted">${empty user.address ? '-' :
                                                            user.address}</div>
                                                    </td>
                                                    <td>
                                                        <c:choose>
                                                            <c:when test="${user.role.name == 'ADMIN'}">
                                                                <span
                                                                    class="role-pill bg-danger-subtle text-danger">ADMIN</span>
                                                            </c:when>
                                                            <c:otherwise>
                                                                <span
                                                                    class="role-pill bg-primary-subtle text-primary">${user.role.name}</span>
                                                            </c:otherwise>
                                                        </c:choose>
                                                    </td>
                                                    <td>
                                            ...
                                            <c:if test="${empty users1}">
                                                <tr>
                                                    <td colspan="5" class="text-center text-muted py-4">Không có user
                                                        phù hợp bộ lọc.</td>
                                                </tr>
                                            </c:if>
                                        </tbody>
