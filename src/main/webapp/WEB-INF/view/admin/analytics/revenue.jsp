            ...
            <div class="container-fluid px-4">
                ...
                <div class="card admin-card mb-4">
                    <div class="card-header bg-white d-flex justify-content-between align-items-center">
                        <h5 class="fw-semibold mb-0"><i class="fas fa-chart-column me-2 text-primary"></i>Revenue Trend</h5>
                        <a href="/admin/analytics/orders" class="btn btn-sm btn-outline-primary">Trang tiếp: Orders</a>
                    </div>
                    <div class="card-body">
