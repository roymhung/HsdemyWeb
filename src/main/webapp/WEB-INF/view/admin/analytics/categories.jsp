            ...
            <div class="container-fluid px-4">
                ...
                <div class="card admin-card mb-4">
                    <div class="card-header bg-white d-flex justify-content-between align-items-center">
                        <h5 class="fw-semibold mb-0"><i class="fas fa-chart-bar me-2 text-primary"></i>Category Comparison</h5>
                        <a href="/admin/analytics/purchases" class="btn btn-sm btn-outline-primary">Trang tiếp: Purchases</a>
                    </div>
                    <div class="card-body">
