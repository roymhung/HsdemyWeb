                        ...
                        <main>
                            <div class="container-fluid px-4">
                                ...
                                <ol class="breadcrumb mb-4">
                                    ...
                                    <li class="breadcrumb-item"><a href="/admin/course/${course.id}">Chi tiết khóa
                                            học</a></li>
                                    <li class="breadcrumb-item active">Chương ${chapter.position}</li>
                                </ol>

                                <div class="alert alert-info">
                                    <strong>Chương:</strong> ${chapter.title}
                                </div>

                                <div class="card mb-4">
                                    <div class="card-header fw-semibold">Thêm Topic mới</div>
                                    <div class="card-body">
                                        <form:form method="POST" action="/admin/chapter/${chapter.id}/topic/create"
                                            modelAttribute="newTopic" enctype="multipart/form-data" class="row g-3">
                                            <div class="col-md-2">
                                            ...
                                            <div class="col-md-6">
                                                <label class="form-label">Tiêu đề (Tên video)</label>
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <form:input path="duration" type="number" min="0"
                                                    class="form-control" />
                                            </div>

                                            <div class="col-md-2 d-flex align-items-end">
                                                <div class="form-check">
                                                    <form:checkbox path="preview" class="form-check-input"
                                                        id="previewCheck" />
                                                    <label class="form-check-label" for="previewCheck">Xem trước</label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12">
                                                <label class="form-label">Tải video lên (mp4, mov)</label>
                                                <input type="file" name="videoFile"
                                                    accept=".mp4,.mov,video/mp4,video/quicktime" class="form-control"
                                                    required />
                                                <form:errors path="videoUrl"
                                                    cssClass="text-danger small d-block mt-1" />
                                            </div>
                                            ...
                                            <div class="col-12 d-flex gap-2">
                                                ...
                                                <a href="/admin/course/${course.id}"
                                                    class="btn btn-outline-secondary">Quay lại chi tiết khóa học</a>
                                            </div>
                                        </form:form>
                                    </div>
                                </div>
                                        ...
                                        <table class="table table-bordered align-middle">
                                            ...
                                            <tbody>
                                                ...
                                                <c:if test="${empty topics}">
                                                    <tr>
                                                        <td colspan="5" class="text-center text-muted">Chưa có topic
                                                            nào.</td>
                                                    </tr>
                                                </c:if>
                                            </tbody>
