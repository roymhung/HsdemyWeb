                        ...
                        <main>
                            <div class="container-fluid px-4">
                                <div class="admin-page-heading">
                                    <h1 class="mt-4 mb-1">Quản lý giao dịch mua</h1>
                                    <p class="text-muted mb-4">Theo dõi từng lượt mua khóa học, trạng thái thanh toán và
                                        hiệu suất doanh thu theo Danh mục.</p>
                                </div>
                                ...
                                <div class="card admin-card mb-4">
                                    <div class="card-header bg-white">
                                        <h5 class="fw-semibold mb-0"><i class="fas fa-filter me-2 text-primary"></i>Bộ
                                            lọc giao dịch mua</h5>
                                    </div>
                                    <div class="card-body">
                                ...
                                <div class="card admin-card mb-4">
                                    <div class="card-header bg-white">
                                        <h5 class="fw-semibold mb-0"><i class="fas fa-table me-2 text-primary"></i>Danh
                                            sách lượt mua</h5>
                                    </div>
                                            ...
                                            <tbody>
                                                <c:forEach var="row" items="${rows}">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="/admin/order?q=${row.orderId}"
                                                                class="text-decoration-none">#${row.orderId}</a>
                                                        </td>
                                                        <td>
                                                        ...
                                                        <td><span class="badge text-bg-light">${row.category}</span>
                                                        </td>
                                                        <td>
                                                            <fmt:formatNumber value="${row.amount}" type="number"
                                                                groupingUsed="true" maxFractionDigits="0" /> đ
                                                        </td>
                                                        <td>
                                                            <c:choose>
                                                                ...
                                                                <c:when
                                                                    test="${row.status == 'FAILED' || row.status == 'CANCELLED'}">
                                                                    <span
                                                                ...
                                                                <c:otherwise>
                                                                    <span
                                                                        class="badge text-bg-secondary">${row.status}</span>
                                                                </c:otherwise>
                                                            </c:choose>
                                                        </td>
                                                        <td>
