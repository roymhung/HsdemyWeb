                        ...
                        <div class="card-body p-3 p-md-4">
                            ...
                            <form method="get" action="/courses">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="q" value="${selectedKeyword}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" name="level">
                                        ...
                                        <c:forEach var="item" items="${levels}">
                                            <option value="${item}" ${selectedLevel == item ? 'selected' : ''}>${item}
                                            </option>
                                        </c:forEach>
                                    </select>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" name="title">
                                        ...
                                        <c:forEach var="item" items="${titles}">
                                            <option value="${item}" ${selectedTitle == item ? 'selected' : ''}>${item}
                                            </option>
                                        </c:forEach>
                                    </select>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" name="sort">
                                        ...
                                        <option value="price-asc" ${selectedSort == 'price-asc' ? 'selected' : ''}>Giá tăng
                                            dần</option>
                                        <option value="price-desc" ${selectedSort == 'price-desc' ? 'selected' : ''}>Giá giảm
                                            dần</option>
                                    </select>
                                </div>
                        ...
                        <c:forEach var="course" items="${courses}">
                            <div class="col-md-6 col-xl-4">
                                <div class="card course-card h-100">
                                    <img src="/images/course/${course.thumbnail}" class="card-img-top" alt="${course.name}"
