    ...
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        ...
        <head>
            ...
            <style>
                ...
                .learning-topbar .brand {
                    font-weight: 700;
                    letter-spacing: .2px;
                }

                .learning-topbar .progress-text {
                    font-size: .9rem;
                    color: #d1d5db;
                }
                ...
                .lesson-item.active .status-icon i {
        ...
        <body>
            <div class="learning-topbar">
                ...
                <div class="d-flex align-items-center gap-2">
                    ...
                    <div class="dropdown">
                        <button class="btn account-btn dropdown-toggle" type="button" data-bs-toggle="dropdown"
                            aria-expanded="false">
                            ...
                            <c:forEach var="chapter" items="${chapters}" varStatus="chapterStatus">
                                <div class="accordion-item">
                                    <h2 class="accordion-header">
                                        <button class="accordion-button ${chapterStatus.first ? '' : 'collapsed'}"
                                            type="button" data-bs-toggle="collapse"
                                            data-bs-target="#learningSection${chapter.id}">
                                    ...
                                    <div id="learningSection${chapter.id}"
                                        class="accordion-collapse collapse ${chapterStatus.first ? 'show' : ''}"
                                            ...
                                            <div class="list-group list-group-flush">
                                                <c:forEach var="topic" items="${chapter.lessons}"
                                                    ...
                                                    <button type="button"
                                                        ...
                                                        data-lesson-id="${topic.id}" data-video-url="${topic.videoUrl}"
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="d-flex align-items-center gap-2">
                                                                ...
                                                                <span
                                                                    class="lesson-title">${chapter.position}.${topic.position}
                                                                    - ${topic.title}</span>
                                                            </div>
                ...
                <div class="progress-box">
                    <div class="d-flex flex-wrap justify-content-between align-items-center gap-3">
                        <div>
                            ...
                            <div class="chapter-meta">Một bài học được đánh dấu hoàn thành khi xem >= 2/3 thời lượng
                                video.</div>
                        </div>
                        <div class="text-end">
                            <div class="chapter-meta">Đã hoàn thành</div>
                            <div class="fw-bold"><span id="completedLessonsContent">0</span>/<span
                                    id="totalLessonsContent">0</span> video</div>
                        </div>
                    </div>
