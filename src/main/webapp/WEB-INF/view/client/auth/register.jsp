                                    ...
                                    <form:form method="post" action="/register" modelAttribute="registerUser">
                                        <div class="row g-3">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input class="form-control" type="text" path="lastName"
                                                    placeholder="Nguyễn" required>
                                            </div>

                                            <div class="col-md-6">
                                                <label class="form-label fw-semibold">Tên (First name)</label>
                                                <input class="form-control" type="text" path="firstName"
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input class="form-control" type="password" path="password"
                                                    placeholder="Tối thiểu 6 ký tự" required>
                                            </div>

                                            <div class="col-md-6">
                                                <label class="form-label fw-semibold">Xác nhận mật khẩu</label>
                                                <input class="form-control" type="password" path="confirmPassword"
