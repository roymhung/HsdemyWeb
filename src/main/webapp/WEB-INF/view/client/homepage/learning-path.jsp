    ...
    <body>
        ...
        <section class="page-hero py-5">
            <div class="container py-4">
                ...
                <p class="page-hero-desc mb-4">Chọn một lộ trình phù hợp để học đúng thứ tự, tiết kiệm thời gian và tăng
                    tốc kỹ năng.</p>
        ...
        <section class="py-5 bg-light">
            <div class="container">
                ...
                <div class="text-center mb-4">
                    ...
                    <p class="text-muted mb-0">Bạn có thể bắt đầu từ một lộ trình và mở rộng dần theo mục tiêu cá nhân.
                    </p>
                </div>
                <div class="row g-4">
                    <div class="col-lg-4 col-md-6">
                        <div class="card path-card p-4">
                            ...
                            <p class="text-muted mb-3">Lộ trình từ HTML/CSS đến Spring Boot và triển khai dự án thực tế.
                            </p>
                            ...
                            <a href="/courses?title=IT_DESIGN" class="btn btn-outline-primary mt-auto">Xem khóa học liên
                                quan</a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card path-card p-4">
                            ...
                            <p class="text-muted mb-3">Tập trung phát triển kỹ năng bán hàng, marketing online và tăng
                                trưởng doanh thu.</p>
                            <ul class="text-muted small ps-3 mb-4">
                            ...
                            <a href="/courses?title=BUSINESS_MARKETING" class="btn btn-outline-success mt-auto">Bắt đầu
                                lộ trình</a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card path-card p-4">
                            ...
                            <p class="text-muted mb-3">Lộ trình thực hành ngoại ngữ theo bối cảnh công việc và học
                                thuật.</p>
                            <ul class="text-muted small ps-3 mb-4">
                ...
                <div class="card border-0 shadow-sm mt-4">
                    <div class="card-body p-4 p-md-5">
                        ...
                        <div class="row g-3">
                            <div class="col-md-4"><i class="bi bi-check-circle text-success me-2"></i>Đặt mục tiêu theo
                                tuần</div>
                            <div class="col-md-4"><i class="bi bi-check-circle text-success me-2"></i>Học theo thứ tự từ
                                cơ bản</div>
                            <div class="col-md-4"><i class="bi bi-check-circle text-success me-2"></i>Ứng dụng ngay qua
                                dự án nhỏ</div>
                        </div>
